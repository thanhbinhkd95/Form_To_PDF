  ...
  return (
    <div className="app-bg-white">
      ...
      <div className="app-header">
        <div className="app-logo">入学願書システム / Application Form System</div>
      </div>
        ...
        <div className="container">
          <div className="form-section">
            <div className="form-header-info">
              ...
              <p>以下のフォームに必要事項を記入してください。すべての項目を正確に入力することが重要です。</p>
              <p>Please fill out the form below with the required information. It is important to accurately input all items.</p>
            </div>
