      ...
      <div className="success-container">
        ...
        <div className="success-message">
          <h1 className="success-title">
            ...
            <span className="success-title-en">
          ...
          <div className="success-description">
            ...
            <p className="success-description-en">
              ...
              <br />
              You can review your submitted form and use the preview feature as
              needed.
            </p>
          </div>
        </div>
        ...
        <div className="success-actions">
          ...
          <button className="btn btn-primary" onClick={navigateToPreview}>
            <span className="btn-text-jp">
              提出した申請書を確認 / Review Submitted Application
            </span>
          </button>
        </div>
        ...
        <div className="success-footer">
          <p className="success-footer-text">
            <span className="success-footer-jp">
              申請に関するご質問がございましたら、お気軽にお問い合わせください。
            </span>
            <span className="success-footer-en">
